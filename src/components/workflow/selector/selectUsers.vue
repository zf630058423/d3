<template>
  <div class="f2bpm-page-layout">
    <el-container :style="{ height: containerHeight }" style="border-bottom: 1px solid #eee;">
      <el-aside ref="sideLeft" hide-trigger collapsible :width="isCollapsed?'20px':'200px'">
        ...
        <div v-if="!isCollapsed" class="f2bpm-page-left-content  mt4">
          ...
          <el-tree ref="mytree" :style="{height:containerHeight-40+'px'}" node-key="id" :default-expanded-keys="defaultExpandedKeys" :data="treeData" :expand-on-click-node="false" :filter-node-method="filterTreeNode" @node-click="onTreeSelected" />
        </div>
      </el-aside>
      <el-main class="f2bpm-page-right" style="overflow: hidden;border-right: 1px solid #eee;border-left: 1px solid #eee;">
        <div id="gridSearch" class="grid-search-form">
          ...
          <div class="grid-search-form-searchbtn-toolbar">
            <el-input v-model="searchParams.searchtext" size="small" placeholder="请输入姓名,账号来查询" clearable style="width: 257px; margin-right: 5px" :searchfields="searchParams.searchfields" @keyup.enter.native="dataGridSearch" />
        ...
        <f2bpm-datagrid
          ref="grid"
          grid="grid"
          :grid-height="containerHeight+175"
      ...
      <el-aside ref="sideRight" width="180px">
        <f2bpm-datagrid ref="gridResult" grid="gridResult" :grid-height="containerHeight+250" :data="resultGridData" :columns="resultGridColumn" />
        <div class="p3">
