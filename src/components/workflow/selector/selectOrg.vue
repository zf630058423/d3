  ...
  <div class="f2bpm-page-layout">
    <el-container :style="{ height: containerHeight + 'px' }">
      ...
      <el-aside ref="sideRight" class="f2bpm-selector-page-right" width="260px">
        <div style="padding-left: 3px; height: 340px" :style="{ height: containerHeight - 40 + 'px' }">
          <f2bpm-datagrid
            ref="gridResult"
            grid="gridResult"
            :data="resultGridData"
...
export default {
  ...
  methods: {
    initData() {
      ...
      if (!this.containerHeight) window.autoPageHeight();
    },
    collapsedSider() {
