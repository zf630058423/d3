    ...
    <el-container :style="{height: containerHeight+'px'}">
      <el-aside ref="sideLeft" class="f2bpm-page-left" hide-trigger collapsible :width="isCollapsed?'20px':'250px'">
        ...
        <div v-if="!isCollapsed" class="f2bpm-page-left-content auto-window-height-select mt4">
          <el-tree ref="mytree" :style="{height:containerHeight-40+'px'}" :data="treeData" :filter-node-method="filterTreeNode" :expand-on-click-node="false" default-expand-all @node-click="onTreeSelected" />
        </div>
      </el-aside>
      <el-aside ref="sideRight" class="f2bpm-selector-page-right" width="260px">
        <div style="padding-left: 3px; ">
          <f2bpm-datagrid ref="gridResult" grid="gridResult" :data="resultGridData" :columns="resultGridColumn" :grid-height="containerHeight+230" />
          <div class="p3">
