...
<script>
  export default {
    ...
    created() {
      ...
      var dg = FUI.DataGrid.Create(that, 'f2bpm_demo_url_form', 'f2bpm_demo_url_form', 'grid', true, true, true);
      dg.SortName = 'id';
      dg.SortOrder = 'desc';
      dg.ShowNumbers = true;
      dg.ExpansMore = true;
      dg.Url = '/workflow/demo/demoUrlForm/getListByPage';
      ...
      dg.EditUrl = '/workflow/demo/demoUrlFormEdit';
      dg.EditTitle = '测试';
      dg.Bind();
    },
    mounted() {
