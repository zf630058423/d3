  ...
  export default {
    ...
    methods: {
      ...
      getGridData() {
        ...
        // ================特殊条件=======================
        // s_true本部门查询（默认）,s_allsub本部门及所有子部门查询
        // m_true本部门管理（默认）,m_allsub本部门及所有子部门管理
        var operatorType = Object.toQueryString('operatorType') || '';
        var isFilterByOrgId = 'true';
        var ishide = false;
        if (operatorType == '' || operatorType == 's_true') {
          ishide = true;
          isFilterByOrgId = 'true';
        } else if (operatorType == 's_allsub') {
          ishide = true;
          isFilterByOrgId = 'allsub';
        } else if (operatorType == 'm_true') {
          ishide = false;
          isFilterByOrgId = 'true';
        } else if (operatorType == 'm_allsub') {
          ishide = false;
          isFilterByOrgId = 'allsub';
        }
        parm.ishide = ishide;
        parm.isFilterByOrgId = isFilterByOrgId;
        parm.isAuthorizeSourceFilter = false;
        // ================特殊条件=======================
