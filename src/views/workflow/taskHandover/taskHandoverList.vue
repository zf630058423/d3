...
<script>
  export default {
    ...
    created() {
      ...
      var dg = FUI.DataGrid.Create(that, 'f2bpm_TaskHandover', 'f2bpm_TaskHandover', 'grid', true, true, true)
      dg.SortName = 'HandoverTime'
      dg.SortOrder = 'desc'
      dg.ShowNumbers = true
      dg.ExpansMore = true
      ...
      dg.EditUrl = '/workflow/taskHandover/taskHandoverEdit'
      dg.EditTitle = '已办交接'
      dg.Bind()
    },
    mounted() {
