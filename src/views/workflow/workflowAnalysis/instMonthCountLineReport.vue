  ...
  export default {
    ...
    methods: {
      ...
      , loadReport(timePeriod, startOpenBizDate, endOpenBizDate, appId, appName) {
        ...
        var jsonData = Object.toAjaxJson(ajaxUrl, 'getWorkflowInstanceAppIdYearMonthReportJson', { startOpenBizDate: startOpenBizDate, endOpenBizDate: endOpenBizDate, appId: appId });
        var total = 0;
        appName = appName || '【所有】';
        var categories = [];// X轴的月份
