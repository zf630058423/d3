  ...
  <div class="f2bpm-page-dialog-layout">
    <el-container>
      <el-main class="f2bpm-page-right">
        ...
        <f2bpm-datagrid :expand-search="expandSearch" ref="grid" grid="grid" height="full-100" :expand-subheight="100" :toolbar="tableToolbar" :context-menu="{header: {options: headerMenus},className: 'my-menus'}" :pager-config="tablePage" :data="tableData" :columns="tableColumn" @checkbox-all="selectAllEvent" @checkbox-change="selectChangeEvent" @radio-change="selectChangeEvent" @header-contextmenu="contextMenuClickEvent" @page-change="pageChange" @sort-change="sortChange" />
      </el-main>
...
<script>
  export default {
    ...
    created() {
      ...
      var dg = FUI.DataGrid.Create(that, 'key_selector_FormDefTableRel', null, 'grid', true, true, true);
      dg.SortName = 'CreatedTime';
      dg.SortOrder = 'desc';
      dg.DefaultWhere = "RefFormDefId='" + formDefId + "'";
      // 是否开启双击编辑
