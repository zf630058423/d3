<template>
  <div class="f2bpm-page-dialog-layout">
    <el-form ref="formRef" size="mini" :rules="formRules" :model="data" class="f2bpm-editform" label-width="120px">
      ...
      <!-- <div class="fence-box column-height" style="width:30px;">
        <span class="fa fa-save" title="向上升序" @click="upOrderNo('up')"></span> <br /> <span class="fa fa-save" title="向下降序" @click="upOrderNo('down')"></span>
      </div> -->
    </el-form>
  </div>
</template>
      ...
      loadWindowparms() {
       ...
       save() {
        ...
        if (comparValue.indexOf("'") >-1) {
          FUI.Window.showMsg('比较值不能包含有单引号')
          return false
        }
