  ...
  export default {
    ...
    methods: {
      ...
      loadTree() {
        var that = this;
        var treeUrl;
        let baseType =  localStorage.getItem('baseType')
        console.log(baseType ,111)
        if(baseType == '99'){
          treeUrl = FUI.Handlers.SmartFormHandler + 'getBoTreeJsonByDevWid/?isNeedField=true&formDefId=' + that.formDefId + '&wid=' + that.wid;
        }else if(baseType == 'a100'){
          // workflow/smartForm/getBoTreeJsonByDevWid
          treeUrl = FUI.Handlers.SmartFormHandler + 'getBoTreeJsonByDevWid/?isNeedField=true&formDefId=' + that.formDefId + '&wid=' + that.wid;
        } else{
          treeUrl = FUI.Handlers.SmartFormHandler + 'getBoTreeJsonByFormDefId/?isNeedField=true&formDefId=' + that.formDefId + '&wid=' + that.wid;
        }
