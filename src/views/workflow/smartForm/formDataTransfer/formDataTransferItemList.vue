...
<script>
  export default {
    ...
    created() {
      ...
      that.transferId = transferId;
      var dg = FUI.DataGrid.Create(that, 'f2bpm_form_data_transfer_item', 'f2bpm_form_data_transfer_item', 'grid', true, true, true);
      dg.SortName = 'item_id';
      dg.SortOrder = 'asc';
      dg.ShowNumbers = true;
      dg.ExpansMore = true;
      dg.DefaultWhere = "transfer_id='" + transferId + "'";
      ...
      dg.EditUrl = '/workflow/smartForm/formDataTransfer/formDataTransferItemEdit/?transferId=' + transferId;
      dg.EditTitle = '编辑字段转换关系';
      dg.Bind();
    },
    mounted() {
      window.myvm = this;
