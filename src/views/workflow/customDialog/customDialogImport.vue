...
<script>
  export default {
    data() {
      return {
        postUrl: __serverpath +  '/workflow/customDialog/uploadImportCustomDialogXml',
        headers: {},
         data: {
          deployType: 'OriAdd'
        }
