...
<script>
  export default {
    ...
    created() {
      var that = this;
      var dg = FUI.DataGrid.Create(that, 'f2bpm_ProcessVar', 'f2bpm_ProcessVar', 'grid', true, true, true);
      dg.SortName = 'VarId';
      dg.SortOrder = 'desc';
      dg.ShowNumbers = true;
      dg.ExpansMore = false;
      ...
      dg.EditUrl = '/workflow/processVar/processVarEdit/';
      dg.EditTitle = '变量定义';
      dg.Bind();
    },
    mounted() {
    ...
    methods: {
      ...
      showDialogEdit(formAction, keyId) {
        ...
        FUI.Window.openEdit(that.dg.EditUrl, title, formAction, that.dg.GridId, 700, 500, null, that.dg.MainTable, keyId);
      },
      // 工具栏按钮事件
