<template>
  <div :fieldrender="field.vModel">
    <div v-show="isShow"> <img field="field.vModel" handsign-field="field.vModel" :src="src" :width="width" /></div>
    <el-button :field="field.vModel" size="mini" v-if="!isReadOnly" type="primary" title="选择" @click="openDialogClick"><i class="icon icon-yinzhang"> </i>选择图章</el-button>
  </div>
</template>
