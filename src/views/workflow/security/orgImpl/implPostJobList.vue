...
<script>
  export default {
    ...
    created() {
      var $vm = this;
      var dg = FUI.DataGrid.Create($vm, 'adaptation_table_PostJob', 'adaptation_table_PostJob', 'grid', false, true, true);
      dg.SortName = 'none';
      dg.SortOrder = 'asc';
      dg.Url = FUI.Handlers.OrgImplController + 'getPostJobListJsonByPage';
      // 是否开启双击编辑
