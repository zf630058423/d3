  ...
  <div class="f2bpm-page-layout">
    <el-container>
      <el-aside ref="sideLeft" class="f2bpm-page-left" hide-trigger collapsible :width="isCollapsed?'20px':'200px'">
        ...
        <div v-if="!isCollapsed" class="f2bpm-page-left-content" :style="'height:'+countLeftTreeHeight+'px;'">
    ...
    data() {
      return {
        ...
        tableColumn: [
          ...
          { field: 'email', type: 'html', title: '邮箱', width: 150, align: 'center' },
          {
            field: 'mobile', type: 'html', title: '手机', width: 150, align: 'center',
            formatter: function (row, column, value, index) {
              var myreg = /^(((13[0-9]{1})|(15[0-9]{1})|(18[0-9]{1}))+\d{8})$/;
              if (!myreg.test(row.mobile)) {
                return row.mobile;
              } else {
                return row.mobile.substring(0, 3) + '*****' + row.mobile.substring(8);
              }
            }
          },
