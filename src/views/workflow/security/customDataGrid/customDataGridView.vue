...
import { getTableList } from '@/Api/workflowBusssion/index.js'
export default {
  components: {
    CommonImpotDilog
  },
    ...
    methods: {
      ...
      load() {
        ...
        that.dataSource = '';
        that.subTableName = '';
        if (Object.toQueryString('keyWord')) that.keyWord = Object.toQueryString('keyWord')
      ...
      async getGridData() {
        ...
        if (Object.toQueryString('keyword')) {
          // 自定义列表
          const res = await getTableList(that.keyWord, parm);
          if (res.code === 200) {
