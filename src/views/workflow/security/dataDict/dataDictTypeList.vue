...
<script>
  export default {
    ...
    created() {
        ...
        var dg = FUI.DataGrid.Create(that, 'f2bpm_sys_data_dict_type', 'f2bpm_sys_data_dict_type', 'grid', true, true, true);
        dg.SortName = 'id';
        dg.SortOrder = 'desc';
        dg.ShowNumbers = true;
        dg.ExpansMore = true;
        ...
        dg.EditUrl = '/workflow/security/dataDict/dataDictTypeEdit';
        dg.EditTitle = '数据字典类型';
        dg.Bind();
    },
    mounted() {
