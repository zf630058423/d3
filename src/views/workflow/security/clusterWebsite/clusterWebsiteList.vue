...
<script>
  export default {
    ...
    created() {
      ...
      var dg = FUI.DataGrid.Create(that, 'f2bpm_sys_ClusterWebsite', 'f2bpm_sys_ClusterWebsite', 'grid', true, true, true);
      dg.SortName = 'Id';
      dg.SortOrder = 'desc';
      dg.ShowNumbers = true;
      dg.ExpansMore = false;
      ...
      dg.EditUrl = '/workflow/security/clusterWebsite/clusterWebsiteEdit/';
      dg.EditTitle = '部署站点';
      dg.Bind();
    },
    mounted() {
