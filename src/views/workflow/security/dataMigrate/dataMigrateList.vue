...
<script>
  export default {
    ...
    created() {
      var that = this;
      var dg = FUI.DataGrid.Create(that, 'f2bpm_sys_DataMigrate', 'f2bpm_sys_DataMigrate', 'grid', true, true, true);
      ...
      dg.EditUrl = '/workflow/security/dataMigrate/dataMigrateEdit/';
      dg.EditTitle = '发起参数配置';
      dg.Bind();
    },
    mounted() {
