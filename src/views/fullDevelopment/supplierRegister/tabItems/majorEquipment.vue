    ...
    <el-table :data="tableData" style="width: 100%;" row-key="id" :key="tableKey" border stripe size="small"
      ...
      <el-table-column label="名称">
        <template slot-scope="scope">
          <el-input style="width: 80%" v-model="scope.row.mingChen" size="small" placeholder="请输入"></el-input>
        </template>
      </el-table-column>
      <el-table-column label="数量" class="is-required">
        <template slot-scope="scope">
          <el-input style="width: 80%" type="number" v-model="scope.row.shuLiang" size="small" placeholder="请输入"></el-input>
        </template>
      </el-table-column>
      <el-table-column label="产日量(台)" class="is-required">
        <template slot-scope="scope">
          <el-input style="width: 80%" type="number" v-model="scope.row.chanRiTai" size="small" placeholder="请输入"></el-input>
        </template>
      </el-table-column>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // 返回表格数据
      setData(){
        this.$emit('showData',7, this.tableData)
      },
