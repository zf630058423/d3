  ...
  <el-dialog title="收货地址"
    ...
    <el-form :model="data"
      ...
      <el-form-item label="任务名称"
                    prop="nodeName"
                    label-width="100px">
        <el-input v-model="data.nodeName"
                  placeholder="请输入任务名称"></el-input>
      </el-form-item>
      <el-form-item label="任务分配到人"
                    label-width="100px">
        <el-switch v-model="data.isAllocate"
      ...
      <el-form-item label="责任人"
        ...
        <el-input disabled
                  placeholder="请选择责任人"
                  v-model="data.dutyPeople">
          <el-button slot="append"
                     :disabled="data.isAllocate!==1"
                     icon="el-icon-search"
                     @click="selectStrUsers('dutyPeople', 'dutyPeopleID', true)"></el-button>
        </el-input>
      </el-form-item>
      <el-form-item label="计划开始日期"
                    label-width="100px"
                    prop="planBeginTime">
        <el-date-picker v-model="data.planBeginTime"
                        :disabled="data.isAllocate!==1"
                        type="date"
      ...
      <el-form-item label="计划结束日期"
                    label-width="100px"
                    prop="planEndTime">
        <el-date-picker v-model="data.planEndTime"
                        :disabled="data.isAllocate!==1"
                        value-format="yyyy-MM-dd"
                        format="yyyy-MM-dd"
                        type="date"
