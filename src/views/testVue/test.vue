              ...
              <el-form-item label="项目编号：" prop="projectNo">
                ...
                >
                  <el-button
                    ...
                    @click="
                      openCustomDialog(
                        '3ddedfb0-9b70-47f4-9016-466a4d684ee5',
                        '项目编号',
      ...
      <div class="planCenter">
        ...
        >
          ...
          <div class="contentBtn-box" v-if="isReadOnly !== true">
            <el-button type="primary" size="small" @click="fatherNode('', '')"
              >新增</el-button
            >
          ...
          >
            ...
            <el-table-column label="操作" align="center" width="150px">
              <template slot-scope="scope" v-if="isReadOnly !== true">
                <el-button
                  type="text"
                  v-if="scope.row.isAllocate == 0 && scope.row.idx !== 2"
                  @click="addSonNode(scope.row, 'add')"
                  >新增</el-button
                >
                <el-button type="text" @click="editNode(scope.row, 'edit')"
                  >编辑</el-button
                >
...
export default {
  ...
  methods: {
    ...
    // 获取详情
    getProjectData (id) {
      let res = Object.toExtendAjax(
        '/extend/engmanager',
        '/queryPlanOrganization',
        { wiid: id },
        false,
        'get'
      )
