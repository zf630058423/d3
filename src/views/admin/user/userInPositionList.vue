...
<script>
  export default {
    ...
    created() {
        ...
        var dg = FUI.DataGrid.Create(that, 'sys_userinposition', 'sys_userinposition', 'grid', true, true, true);
        dg.SortName = 'id';
        dg.SortOrder = 'desc';
        dg.ShowNumbers = true;
        dg.ExpansMore = true;
        //注释此行dg.Url从自己的Controller后端拿数据
        //dg.Url = '/admin/user/getListByPage';
        ...
        dg.EditUrl = '/admin/user/userInPositionEdit';
        dg.EditTitle = '【用户岗位】';
        dg.Bind();
    },
    mounted() {
