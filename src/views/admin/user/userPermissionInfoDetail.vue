          ...
          <div id="gridSearch" class="grid-search-form">
            <div id="grid-search-form-list" class=" grid-search-form-list  ">
              <ul>
                ...
                <li>
                  <label>角色：</label>
                  <el-input  v-model="searchParams.targetName" size="mini" clearable class="textBoxShort" />
                </li>
                <li>
                  <label>按钮：</label>
  ...
  export default {
    ...
    methods: {
      ...
      getGridData() {
        ...
        parm.userId = that.userId;
        var res = Object.toAjaxJson('/admin/userPermission/', 'getUserPermissionDetailJson', parm, true, null,
          function (res) {
            if (res.success) {
