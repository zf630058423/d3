    ...
    <el-form class="class" :model="dataForm" ref="dataForm" label-suffix="：" :rules="dataRule" label-width="180px">
      ...
      <row-layout title="申请信息" :cols="3">
         <el-form-item label="开票申请单号" slot="col_1" prop="invoiceOpenApplyMainCode">
          ...
          <!-- <el-input v-model="dataForm.invoiceOpenApplyMainCode"></el-input> -->
        </el-form-item>
      ...
      <row-layout :cols="3">
        <el-form-item label="开票日期" slot="col_1" prop="invoiceCreateTime">
          <el-date-picker v-model="dataForm.invoiceCreateTime" type="datetime" :placeholder="msgTip.AUTO_PLACEHOLDER"></el-date-picker>
        </el-form-item>
      ...
      <row-layout :cols="3">
        <el-form-item label="数据源" slot="col_1" prop="dataSource">
          <el-input v-model="dataForm.dataSource" :disabled="getDisabledField('dataSource')" :placeholder="msgTip.ENTER_PLACEHOLDER"></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    beforeInit() { 
      ...
      this.getDataDictByConfigType('发票类型,开票状态,对接状态,优惠政策');
    },
    afterInit() { 
    ...
    invoiceOpenApplyMainCodeChange(data) {
      ...
      if (data.length > 0) { 
        this.dataForm.invoiceOpenApplyMainCode = data[0].code || '';
