  ...
  <div class="detail-list">
    <el-form ref="subFrom" :model="subFormData" :rules="rules">
      ...
      @selection-change="handleSelectionChange">
        ...
        <el-table-column label="百旺开票" prop="preferentialPolicy" :align="alignCenter" width="200">
          <template slot-scope="scope">
        ...
        <el-table-column label="开票申请金额(含税)(元)" prop="objectNumber" width="200" :align="alignCenter">
          <template slot-scope="scope">
        ...
        <el-table-column label="对接状态" prop="contentMakeOutInvoice" :align="alignCenter" width="180">
          <template slot-scope="scope">
            <text-input v-model="scope.row.contentMakeOutInvoice" :disabled="getDisFiled('contentMakeOutInvoice')"></text-input>
          </template>
        </el-table-column>
        <el-table-column label="对接备注" prop="specification" :align="alignCenter" width="180">
          <template slot-scope="scope">
            <text-input v-model="scope.row.specification" :disabled="getDisFiled('specification')"></text-input>
          </template>
        </el-table-column>
        <el-table-column label="操作人" prop="taxRate" :align="alignCenter" width="150">
          <template slot-scope="scope">
        ...
        <el-table-column label="操作时间" prop="unit" :align="alignCenter" width="150">
          <template slot-scope="scope">
