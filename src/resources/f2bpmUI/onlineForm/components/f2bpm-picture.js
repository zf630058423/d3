import Vue from 'vue';
// 多选框组件
var f2bpmPicture = Vue.component('f2bpm-picture', {
  ...
  template: '<div><el-upload' +
    ...
    '  :class="{disUoloadSty:uploadDisabled}"' +
    ...
    '    </div>' +
    '</el-upload>' +
    '<el-dialog :visible.sync="dialogVisible"> <img width="100%" :src="dialogImageUrl" alt=""></el-dialog></div>'
