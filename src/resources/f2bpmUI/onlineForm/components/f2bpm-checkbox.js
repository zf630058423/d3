import Vue from 'vue';
// 多选框组件
var f2bpmCheckbox = Vue.component('f2bpm-checkbox', {
  ...
  template: '<el-checkbox-group :disabled="isReadOnly"  v-show="isShow"  @change="onItemClick" v-model="value" :name="field.vModel"><el-checkbox  v-for="(item,  index) in data" :label="item[valueName]"  :key="index">{{item[textName]}}</el-checkbox></el-checkbox-group>'
});
