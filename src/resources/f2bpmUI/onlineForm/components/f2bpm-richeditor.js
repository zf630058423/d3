import Vue from 'vue';
// 注册组件
var f2bpmRicheditor = Vue.component('f2bpm-richeditor', {
  // dataself:数据对象自己，可能是主表的data，也可能是子列表的某行data对象，子列表时必传此值
  props: ['field', 'fieldvalue', 'dataself'],
  data: function () {
    return {
      isView: false,
      isShow: true,
  ...
  template: '<textarea v-model="value" :richeditorContainer="field.vModel"  :toolbarsType="toolbarsType"  :richeditorContainerType="richeditorType"  :id="richeditorId"   :field="field.vModel"  :style="theStyle" ></textarea>'
});
