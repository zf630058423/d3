                            ...
                            <td colspan="2">
                                <fieldset style="padding: 5px;">
                                    ...
                                    <div style="margin: 0 auto; padding: 0 5px;">
                                        <div style="height: 25px; padding: 5px 0;">格式1：选项文本1,选项值1;选项文本2,选项值2</div>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            if (oNode) {
                ...
                if ("custom" == $text.attr("datasource")) {
                    $("#ds_dict").hide();
                    $("#ds_sql").hide();
                    $("#ds_custom").show();
                ...
                else if ("dic" == $text.attr("datasource")) {
                    $("#ds_dict").show();
                    $("#ds_sql").hide();
                    $("#ds_custom").hide();
                ...
                else if ("sql" == $text.attr("datasource")) {
                    $("#ds_dict").hide();
                    $("#ds_sql").show();
                    $("#ds_custom").hide();
